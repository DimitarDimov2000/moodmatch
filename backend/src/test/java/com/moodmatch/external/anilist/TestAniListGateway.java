...
public class TestAniListGateway implements AniListGateway {
    ...
    private static final List<AniListMedia> DEFAULT_RESULTS = List.of(
            ...
            new AniListMedia(
                    ...
                    null,
                    2001,
                    new AniListTitle("Sen to Chihiro no Kamikakushi", "Spirited Away", "千と千尋の神隠し"),
                    "<p>A young girl enters a world of spirits.</p>",
                    new AniListCoverImage("https://img.anilist.co/spirited-away-large.jpg", null),
                    "https://anilist.co/anime/199",
                    List.of("Adventure", "Fantasy"),
                    List.of("Supernatural"),
